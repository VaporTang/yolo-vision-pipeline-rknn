...
def check_overlaps():
    ...
    parser.add_argument("--json-dir", type=str, required=True, help="Directory with JSON annotation files")
    parser.add_argument("--threshold", type=float, default=0.8, help="IoU threshold (0-1)")
...
def split_dataset():
    ...
    parser.add_argument("--image-dir", type=str, required=True, help="Training images directory")
    parser.add_argument("--label-dir", type=str, required=True, help="Training labels directory")
...
def filter_dataset_classes():
    ...
    parser.add_argument("--label-dirs", type=str, nargs='+', required=True, help="Label directories")
    parser.add_argument("--remove-classes", type=int, nargs='+', required=True, help="Class indices to remove")
    args = parser.parse_args()
...
def prepare_calibration():
    ...
    parser.add_argument("--image-dir", type=str, required=True, help="Calibration images directory")
    parser.add_argument("--output", type=str, required=True, help="Output dataset.txt file")
    parser.add_argument("--num-images", type=int, default=20, help="Number of images to use")
    args = parser.parse_args()
